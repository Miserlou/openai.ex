defmodule OpenAI do
  ...
  """
  def completions(config, params) do
    Completions.fetch(config, params)
  end
  ...
  """
  def completions(config, engine_id, params) do
    Completions.fetch(config, engine_id, params)
  end
  ...
  """
  def images_generations(config, params, request_options) do
    Images.Generations.fetch(config, params, request_options)
  end

  @doc """
  alias of images_generations(params, request_options) - will be deprecated in future releases
  """
  def image_generations(config, params, request_options) do
    Images.Generations.fetch(config, params, request_options)
  end
